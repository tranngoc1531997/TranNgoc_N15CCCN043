            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <!-- <a class="collapse-item" href="cards.html">Loại phòng</a>
                        <a class="collapse-item" href="cards.html">Phòng</a> -->
                    </div>
                </div>
            </li>
            <!-- <hr class="sidebar-divider"> -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="./index.php?ctrl=media&act=getallimagebyhotel">Hình ảnh</a>
                        <a class="collapse-item" href="utilities-border.html">Video</a>
                        <a class="collapse-item" href="utilities-animation.html">Khác</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="./index.php?ctrl=hotel&act=show">Tất cả Booking</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['isLogin']?></span>
